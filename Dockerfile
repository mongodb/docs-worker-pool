...
ARG SNOOTY_PARSER_VERSION=0.14.2
ARG SNOOTY_FRONTEND_VERSION=0.14.10
...
# get shared.mk
RUN curl https://raw.githubusercontent.com/mongodb/docs-worker-pool/DOP-3863-meta/makefiles/shared.mk -o shared.mk
