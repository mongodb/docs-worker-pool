...
ARG SNOOTY_PARSER_VERSION=0.14.1
ARG SNOOTY_FRONTEND_VERSION=0.14.8
...
RUN cd ./modules/persistence/ && ls && npm install --legacy-peer-deps
...
RUN cd ./modules/oas-page-builder/ && npm install --legacy-peer-deps
