...
ARG SNOOTY_PARSER_VERSION=0.14.3
ARG SNOOTY_FRONTEND_VERSION=0.14.11
...
# get shared.mk
RUN curl https://raw.githubusercontent.com/mongodb/docs-worker-pool/DOP-3722-meta/makefiles/shared.mk -o shared.mk
